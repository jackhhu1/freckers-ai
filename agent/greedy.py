...
class LightweightBoard:
    ...
    def evaluate(self, color: PlayerColor) -> float:
        ...
        # Sum of Manhattan distances to goal row: lower is better
        ...
        # We want to minimize self_dist, maximize opp_dist, prefer self jumps, discourage opp jumps
        score = (opp_dist - self_dist) * 1.0 + (jump_self - jump_opp) * 0.5
        return score
